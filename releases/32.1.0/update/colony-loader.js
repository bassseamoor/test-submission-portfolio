...
.then(()=>load('https://cdn.jsdelivr.net/gh/bassseamoor/test-submission-portfolio@bb85f1923fb96a1db5f97719764eb24f6166fd05/releases/32.1.0/update/pulse-glass-141-adapter.js','Pulse Glass 141 WebGL2 adapter'))
.then(()=>load('https://cdn.jsdelivr.net/gh/bassseamoor/test-submission-portfolio@bb85f1923fb96a1db5f97719764eb24f6166fd05/releases/32.1.0/update/colony-renderer-pulls.js','Renderer Pulls'))
.catch(err=>console.error('[COLONY 32.1]',err));
})();
