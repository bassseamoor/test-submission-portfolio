...
.then(()=>load('https://cdn.jsdelivr.net/gh/bassseamoor/test-submission-portfolio@0df05a7044d3081ba7398f10a9fed0680400ace0/releases/32.1.1/update/pulse-glass-141-adapter.js','Pulse Glass 141 WebGL2 adapter'))
...
.then(()=>load('https://cdn.jsdelivr.net/gh/bassseamoor/test-submission-portfolio@0df05a7044d3081ba7398f10a9fed0680400ace0/releases/32.1.1/update/pulse-glass-pulls-bridge.js','Pulse Glass Renderer Pulls bridge'))
.catch(err=>console.error('[COLONY 32.1.1]',err));
})();
