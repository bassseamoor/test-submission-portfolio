...
.then(()=>load('https://cdn.jsdelivr.net/gh/bassseamoor/test-submission-portfolio@651fff765df862c6d93df78ab4c7d988484a9889/releases/32.1.2/update/pulse-glass-pulls-bridge.js','Pulse Glass Renderer Pulls bridge'))
.catch(err=>console.error('[COLONY 32.1.2]',err));
})();
